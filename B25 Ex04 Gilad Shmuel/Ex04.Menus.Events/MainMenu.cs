...
namespace Ex04.Menus.Events
{
    public class MainMenu
    {
        ...
        public MainMenu(string i_MenuTitle, bool i_IsRootMenu = true, List<MenuItem> i_MenuItems = null)
        {
        ...
        public void AddMenuItem(MenuItem i_Option)
        {
        ...
        public void Show()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("------------------------");
                int optionCounter = 1;
                foreach (MenuItem option in r_MenuItems)
                {
